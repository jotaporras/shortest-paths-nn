#!/usr/bin/env python
"""
Wandb sweep agent script for TAGConv GNN on Norway res=3.

Usage:
    # 1. Create the sweep (once):
    wandb sweep configs/sweep-gnn-norway.yml
...
WANDB_TAG = "sweep_gnn_norway"

TRAIN_FILE = PROJECT_ROOT / "data" / "res03_hybrid.npz"
TEST_FILE = PROJECT_ROOT / "data" / "generated2" / "full_test-004.npz"
DATASET_NAME = "norway/res03"
RESOLUTION = 3
